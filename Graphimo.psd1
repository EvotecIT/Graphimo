@{
    ...
    FunctionsToExport    = @('Add-GraphGroupMember', 'Add-GraphUser', 'Connect-Graph', 'Get-GraphApplication', 'Get-GraphGroup', 'Get-GraphGroupMember', 'Get-GraphUser', 'Import-GraphGuest', 'Invoke-Graph', 'Remove-GraphGroupMember', 'Remove-GraphUser', 'Set-GraphManager', 'Set-GraphUser')

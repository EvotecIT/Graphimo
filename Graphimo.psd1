@{
    ...
    FunctionsToExport    = @('Add-GraphContact', 'Add-GraphGroupMember', 'Add-GraphUser', 'Connect-Graph', 'Get-GraphApplication', 'Get-GraphContact', 'Get-GraphGroup', 'Get-GraphGroupMember', 'Get-GraphUser', 'Import-GraphGuest', 'Invoke-Graph', 'Remove-GraphContact', 'Remove-GraphGroupMember', 'Remove-GraphManager', 'Remove-GraphUser', 'Set-GraphManager', 'Set-GraphUser')
